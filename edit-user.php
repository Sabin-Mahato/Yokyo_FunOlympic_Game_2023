  ...
  <body>
   ...
   <!-- navbar end -->
    ...
    <div class="col-md-4" style="background-color:#C0C0C0;">
        ...
        <div class="col-md-8">
            <h2 class="display-4">User Signup Details</h2>
            <table class="table table-dark table-hover table-bordered">
                ...
                if (isset($_GET['id'])) {
                    ...
                    if (isset($_POST['updatePassword'])) {
                        ...
                        $updateQuery = "UPDATE usertable SET password = '$newPassword' WHERE id = '$userId'";
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $f; ?></td>
                        <td>
                            <a class="btn btn-primary" href="edit-user.php?id=<?php echo $a; ?>">Edit</a>
                        </td>
                        <td>
                            <a class="btn btn-danger" href="delete.php?id=<?php echo $a; ?>">Delete</a>
                        </td>
                    </tr>
                </tbody>
                <?php 
